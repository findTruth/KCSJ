...
<div class="box" id = "mymodal">
		<div class="login-box">
			...
			<div class="form">
			<form action="<%=basePath %>Manager/login.do" method="post" onsubmit="return check(this)"; id="loginFormId">
				...
				<div class="form-group">
						...
						<div class="col-xs-10">
						   <div>
				               ...
				               &nbsp;&nbsp;<input type="text" name="code" style="width:80px;" id="certCode"/>	 
				...
				<div class="form-group">
					...
					<div class="col-xs-6 link">
						<button type=button class="btn btn-sm btn-info" id="loginBtn" onclick="check();" style="width: 100px;height: 40px;position: absolute; left:190px;top: 10px" ><span class="glyphicon glyphicon-off"></span> 登录</button>
						</p>
					</div>
				</div>
			</form>
