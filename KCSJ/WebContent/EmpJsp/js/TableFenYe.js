...
/*
 * //获取对应控件 var totalPage = document.getElementById("spanTotalPage");//总页数
 * 
 * var pageNum = document.getElementById("spanPageNum");//当前页 var totalInfor =
 * document.getElementById("spanTotalInfor");//记录总数 var pageNum2 =
 * document.getElementById("Text1");//当前页文本框
 * 
 * var spanPre = document.getElementById("spanPre");//上一页 var spanNext =
 * document.getElementById("spanNext");//下一页 var spanFirst =
 * document.getElementById("spanFirst");//首页 var spanLast =
 * document.getElementById("spanLast");//尾页 var pageSize = 5;//每页信息条数
 * 
...
function pre() {
	if (pageCount() <= 1) {
		...
		if (currentRow > numberRowsInTable)
			currentRow = numberRowsInTable;// 如果计算中本页的第一行小于实际首页的第一行行号，则更正
