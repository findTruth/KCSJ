...
<body>
			...
			<div class="col-md-6">
				...
				<div class="collapse navbar-collapse"
					...
					<form class="navbar-form navbar-left" role="search"
						action="<%=basePath%>Manager/queryEmp.do">
						<div class="form-group">
							<span>请输入要查询的姓名或编号：</span> <input class="form-control"
								type="text" placeholder="姓名或员工编号" name="name" />
						</div>
	...
	<table class="table table-striped table-hover"
		style="visibility: hidden" id="updatepanel">
		<thead>
			<tr>
				<th><h3>员工修改</h3></th>
		...
		<tbody>
			...
			<form action="<%=basePath%>Manager/updateEmp.do" method="post">
				...
				<tr class="active">
					...
					<td><input class="form-control" type="text" placeholder="员工编号"
						name="empno" id="empno1" readonly /></td>
					<td><input class="form-control" type="text" placeholder="员工姓名"
						name="name" id="name1" /></td>

					<td><input class="form-control" type="text" placeholder="性别"
						name="sex" id="sex1" /></td>

					<td><input class="form-control" type="text" placeholder="年龄"
						name="age" id="age1" /></td>

					<td><input class="form-control" type="text" placeholder="工资"
						name="sal" id="sal1" /></td>

					<td><input class="form-control" type="text" placeholder="身份证号"
						name="card" id="card1" /></td>
